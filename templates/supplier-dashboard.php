...
<head>
  <meta charset="UTF-8">
  <title>Agrifoodz Dashboard</title>
        ...
        <a href="./" class="return-home">
            <span>
                <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
                    ...
                    <g id="SVGRepo_iconCarrier"> <path d="M22 12.2039V13.725C22 17.6258 22 19.5763 20.8284 20.7881C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 
                    ...
                    stroke="#fff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M15 18H9" stroke="#fff" stroke-width="1.5" stroke-linecap="round"></path> </g>
                </svg>
            </span>
        </a>
                ...
                <div class="main-profile-detail">
                    ...
                    <section class="important-links">
                        <a href="#" class="dashboard-link">
                            <span>
                                <svg width="25px" height="25px" viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.1"></g><g id="SVGRepo_iconCarrier"> 
                                    ...
                                    stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round"></path> <path fill-rule="evenodd" clip-rule="evenodd" 
                                    ...
                                    stroke="#000000" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round"></path> <path fill-rule="evenodd" clip-rule="evenodd" 
                        ...
                        <a href="#" class="edit-profile">
                            <span>
                                <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        ...
                        <a href="#" class="verification-link">
                            <span>
                                <svg width="25px" height="25px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    ...
                                    fill="#ffffff"></path> 
                                    <path d="M8.25 12.75L11.25 15L17.25 9" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g>
                                    <g id="SVGRepo_iconCarrier"> <path d="M4.39254 16.2614C2.64803 13.1941 1.66074 9.71783 1.51646 6.15051C1.50127 5.77507 1.70918 5.42812 2.04153 5.25282L11.5335 
                                    ...
                                    16.2614Z" fill="#ffffff"></path> <path d="M8.25 12.75L11.25 15L17.25 9" stroke="#000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path></g>
                                </svg>
                            </span>
                            <p>Verification</p>
                        </a>
                        <a href="#" class="upgrade-link">
                            <span>
                                <svg height="25px" width="25px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 197.091 197.091" stroke="#000000" stroke-width="0.00197091">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier"><g><g><g><path style="fill:#010002;" d="M32.131,184.928L32.131,184.928c-18.388,0-31.573-2.505-32.131-2.616l0.734-7.648 
                                    ...
                                    c-8.425,10.475-20.113,18.041-34.94,22.651c42.867-1.882,90.753-18.714,94.861-83.362l0.229-3.618h42.527l-66.939-66.946 L44.564,90.028z"></path></g></g></g></g>
                                </svg>
                            </span>
                            <p>Upgrade</p>
                        </a>
                        <a href="#" class="support-link">
                            <span>
                                <svg width="25px" height="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.7" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#000000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier"> <title id="supportIconTitle">Support</title> <path d="M18,9 L16,9 C14.8954305,9 14,9.8954305 14,11 L14,13 C14,14.1045695 
                                    ...
                                    <path d="M21,14 L21,18 C21,20 20.3333333,21 19,21 C17.6666667,21 16,21 14,21"></path> </g>
                                </svg>
                            </span>
                            <p>Support</p>
                        </a>
                ...
                <div class="support-bot-button-wrapper">
                    <button type="button" id="supportBotButton" class="fixed-action">
                        <svg fill="#ffffff" height="35px" width="35px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.001 512.001">
                            ...
                            <g><g><path d="M413.906,65.669C371.559,23.322,315.481,0,256,0c-32.044,0-63.034,6.719-92.108,19.971 c-3.821,1.742-5.507,6.251-3.766,10.073c1.742,3.822,6.251,5.507,10.073,3.766C197.281,21.466,226.148,15.208,256,15.208 
                            ...
                            M464.366,409.266h-16.632v-90.405h16.632V409.266z"></path> </g> </g> <g> <g> 
                            ...
                            M279.304,496.792h-47.993c-7.546,0-13.685-6.14-13.685-13.685 c0-7.545,6.139-13.685,13.685-13.685h47.993c7.546,0,13.685,6.14,13.685,13.685S286.85,496.792,279.304,496.792z"></path></g> </g> </g>
                        </svg>
                    </button>
                </div>
                    ...
                    <div class="faq-container">
                        ...
                        <div class="chat-box">
                            ...
                            <div class="chat-input">
                                ...
                                <button>
                                    <svg width="20px" height="20x" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> 
                                        <path d="M36 24.0083H12" stroke="#fff" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> 
                                        <path d="M24 12L36 24L24 36" stroke="#fff" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path></g>
                                    </svg>
                                </button>
                            </div>
                    ...
                    <div class="step step-4" style="display:none;">
                        ...
                        <div class="upload-photo">
                            ...
                            <div class="upload-area" id="photouploadArea" onclick="document.getElementById('photoInput').click()">
                              <i class="upload-icon">
                                <svg width="35px" height="35px" viewBox="0 0 48 48" id="a" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                                    ...
                                    <g> <circle class="b" cx="24" cy="26.2231" r="8.5069"></circle> <g> <polygon class="b" points="26.4543 21.9723 21.5457 21.9723 19.0914 26.2231 21.5457 30.4739 26.4543 30.4739 
                                    28.9086 26.2231 26.4543 21.9723"></polygon> <line class="b" x1="28.9086" y1="26.2231" x2="31.3693" y2="30.4852"></line> <line class="b" x1="16.6372" y1="21.9723" x2="19.0914" 
                                    y2="26.2231"></line> <line class="b" x1="24" y1="17.7163" x2="21.5457" y2="21.9722"></line> <line class="b" x1="26.4543" y1="30.4741" x2="24" y2="34.73"></line> 
                                    <line class="b" x1="21.5457" y1="30.4741" x2="16.6304" y2="30.4741"></line> <line class="b" x1="26.4543" y1="21.9722" x2="31.3693" y2="21.9722"></line> </g> </g> </g>
                                </svg>
                              </i>
                        ...
                        <div class="no-messages">
                            ...
                            <span>
                                <svg width="20px" height="20px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M6 12H18" stroke="#fff" stroke-width= "2px" stroke-linecap="round" stroke-linejoin="round"></path></g>
                                </svg>
                            </span>
                            Contact Buyers</button>
                        </div>
