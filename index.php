      ...
      <div class="row">
        ...
        <div class="col-3">
          ...
          <nav class="category-nav">
              ...
              <ul class="category-list">
                ...
                <li>
                  <svg fill="#000000" height="20px" width="20px" version="1.1" id="Capa_1"
                    ...
                    <g id="SVGRepo_iconCarrier">
                      <path id="XMLID_1328_"
                        d="M177.266,302.817c-3.282,18.328-15.566,30.171-31.295,30.171c-3.866,0-7-3.134-7-7s3.134-7,7-7 c10.453,0,15.901-9.628,17.514-18.639c0.682-3.805,4.317-6.345,8.125-5.656C175.414,295.375,177.947,299.012,177.266,302.817z M321.995,153.881c0.873,3.083,3.679,5.095,6.731,5.095c0.632,0,1.273-0.086,1.91-0.267c3.721-1.053,5.882-4.922,4.829-8.642 c-6.871-24.272-18.409-47.489-32.488-65.374c-2.391-3.037-6.791-3.563-9.83-1.17c-3.037,2.391-3.562,6.792-1.17,9.83 C304.95,109.834,315.611,131.33,321.995,153.881z M125.594,83.929c-2.814,2.65-2.947,7.081-0.297,9.895 c9.25,9.823,17.696,22.901,24.425,37.822c1.168,2.59,3.717,4.124,6.385,4.124c0.962,0,1.94-0.2,2.874-0.621 c3.524-1.589,5.092-5.734,3.503-9.259c-7.359-16.318-16.694-30.726-26.995-41.665C132.838,81.411,128.408,81.277,125.594,83.929z M403.611,223.044v35.127c0,3.866-3.134,7-7,7h-17.055l-8.986,50.171c-5.133,28.648-24.085,47.16-48.284,47.16h-79.832 c-17.272,0-31.819-9.305-40.648-25.192c-8.829,15.887-23.375,25.192-40.645,25.192H81.329c-24.201,0-43.154-18.511-48.285-47.16 l-8.987-50.171H7c-3.866,0-7-3.134-7-7v-35.127c0-3.866,3.134-7,7-7h25.242c-4.183-20.693-3.462-44.507,2.16-69.5 c6.031-26.806,17.189-52.131,31.419-71.309c16.335-22.015,34.943-33.816,53.812-34.126c0.077-0.001,0.153-0.001,0.23,0 c27.584,0.454,54.958,26.022,73.227,68.395c1.53,3.55-0.107,7.669-3.657,9.2c-3.55,1.53-7.668-0.106-9.2-3.657 c-15.758-36.552-38.925-59.502-60.486-59.938c-14.118,0.285-29.271,10.39-42.684,28.468C50.051,119.984,37.4,175.852,46.568,216.044 h149.79c-4.182-20.693-3.461-44.508,2.162-69.501c6.032-26.807,17.19-52.132,31.419-71.309 C246.274,53.22,264.882,41.42,283.75,41.11c0.076-0.001,0.154-0.001,0.23,0c18.869,0.31,37.477,12.11,53.812,34.125 c14.229,19.178,25.388,44.502,31.418,71.309c5.623,24.993,6.344,48.807,2.161,69.5h25.24 C400.478,216.044,403.611,219.179,403.611,223.044z M210.685,216.044h146.36c9.168-40.193-3.483-96.061-30.496-132.467 C313.135,65.5,297.982,55.395,283.865,55.11c-14.117,0.285-29.27,10.39-42.683,28.466 C214.169,119.982,201.518,175.851,210.685,216.044z M389.611,230.044h-26.971c-0.107,0.002-0.214,0.002-0.321,0H205.408 c-0.104,0.002-0.209,0.002-0.318,0H41.294c-0.108,0.002-0.216,0.002-0.322,0H14v21.127h70.105c3.866,0,7,3.134,7,7s-3.134,7-7,7 H38.28l8.545,47.703c2.943,16.436,13.746,35.628,34.504,35.628h79.832c19.347,0,30.161-16.727,33.83-32.381 c0.742-3.165,3.565-5.403,6.815-5.403s6.074,2.238,6.815,5.403c3.669,15.654,14.482,32.381,33.833,32.381h79.832 c20.756,0,31.559-19.193,34.503-35.628l8.545-47.703h-45.826c-3.866,0-7-3.134-7-7s3.134-7,7-7h70.104V230.044z M299.646,325.988 c0,3.866,3.134,7,7,7c15.727,0,28.012-11.842,31.296-30.17c0.682-3.806-1.851-7.443-5.656-8.125 c-3.803-0.688-7.442,1.851-8.125,5.655c-1.614,9.011-7.063,18.64-17.515,18.64C302.78,318.988,299.646,322.122,299.646,325.988z">
                      </path>
                    </g>
                  </svg>
                  <p>Dairy & Eggs</p>
            ...
            <button class="view-all"><a href="">View All</a></button>
              ...
              <div class="user-information-wrapper">
                <div class="user-content">
                  <div class="user-avatar">
                    <img src="assets/images/user-img4.webp">
                  </div>
          ...
          <div class="swiper-slide buyAd-wrapper-item">
            <div class="list-title list-name">
              <div class="user-information-wrapper">
                <div class="user-content">
                  <div class="user-avatar">
                    <img src="assets/images/user-img.webp">
                  </div>
          ...
          <div class="swiper-slide buyAd-wrapper-item">
            <div class="list-title list-name">
              <div class="user-information-wrapper">
                <div class="user-content">
                  <div class="user-avatar">
                    <img src="assets/images/user-img1.webp">
                  </div>
          ...
          <div class="swiper-slide buyAd-wrapper-item">
            <div class="list-title list-name">
              <div class="user-information-wrapper">
                <div class="user-content">
                  <div class="user-avatar">
                    <img src="assets/images/user-img2.webp">
                  </div>
          ...
          <div class="swiper-slide buyAd-wrapper-item">
            <div class="list-title list-name">
              <div class="user-information-wrapper">
                <div class="user-content">
                  <div class="user-avatar">
                    <img src="assets/images/user-img3.webp">
                  </div>
      ...
      <h2 class="section-title">VIP Supplier</h2>
       ...
       <div class="row">
        <div class="supplier-service">
          ...
          <!-- <a href="#" class="service-btn outline">For Customers</a> -->
          <div class="user-item">
            <img src="assets/images/user-img.webp" alt="">
            <h3>James Komeron</h3>
          </div>
            ...
            <div class="blog-card">
              <a href="/themes/nutskernel/single-post.php">
                ...
                <div class="blog-content">
                  ...
                  <p>Curious about what crops and commodities are set to dominate next year’s global market? We’ve
                    analyzed data from key markets and trade reports to reveal
                    the products gaining the most traction in 2025.</p>
                ...
                <div class="blog-content">
                  ...
                  <div class="blog-meta">
                    ...
                    <span>
                      ...
                      13.5881 21.0003 15.2333 21.0003 17.2619Z" stroke="#00a055" stroke-width="1"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                              <path id="Stroke 7" fill-rule="evenodd" clip-rule="evenodd" d="M10.3467 17.2619C10.3467 19.2905 8.7024 20.9348 6.6729 20.9348C4.6452 20.9348 3 19.2905 3 
                      17.2619C3 15.2333 4.6452 13.5881 6.6729 13.5881C8.7024 13.5881 10.3467 15.2333 10.3467 17.2619Z"
                                stroke="#00a055" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path>
                            </g>
                          </g>
                        </g>
                      </svg>
                  ...
                  <p>From eco-conscious consumers to new import regulations, sustainability isn’t just a buzzword
                    anymore—it’s a market driver.
            ...
            <div class="blog-card">
              <a href="/themes/nutskernel/single-post.php">
                ...
                <div class="blog-content">
                  ...
                  <p>Planning to expand your agri business internationally? Our latest forecast reveals the top
                    importing countries, changing trade policies,
            ...
            <div class="blog-card">
              <a href="/themes/nutskernel/single-post.php">
                ...
                <div class="blog-content">
                  ...
                  <p>Sustainable doesn’t have to mean expensive. Learn actionable strategies to source ethically grown
                    produce while staying competitive in pricing and margins.</p>
                </div>
              </a>
            </div>
          </div>
            ...
            <div class="blog-card">
              <a href="/themes/nutskernel/single-post.php">
                ...
                <div class="blog-content">
                  ...
                  <p>Climate-resilient crops, AI-powered agriculture, and changing consumer demands—these aren’t science
                    fiction anymore.
